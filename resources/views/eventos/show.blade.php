...
<div class="row">
    ...
    <!-- Lista de Perguntas (TICKET #002 e #003) -->
    <div class="col-md-7">
        <div class="d-flex justify-content-between align-items-center mb-3">
            <h4 class="fw-bold m-0">📋 Perguntas do Evento</h4>
            <!-- CORREÇÃO DE PERFORMANCE: Usando o total() do paginador para evitar carregar registros na RAM -->
            ...
            <div class="card mb-3 shadow-sm border-start border-4 border-primary">
                <div class="card-body">
                    ...
                    <div class="d-flex justify-content-between align-items-center text-secondary small">
                        <!-- TICKET #003: Exibição do autor com fallback seguro -->
                        <span>Por: <strong>{{ $pergunta->user->name ?? 'Anônimo' }}</strong></span>
        ...
        @if(method_exists($perguntas, 'links'))
            <div class="d-flex justify-content-center mt-4 m-b-4 pagination-sm">
                {{ $perguntas->links() }}
            </div>
        @endif
    </div>
